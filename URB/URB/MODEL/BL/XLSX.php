<?php
/**
 *    XLSX php class v0.8.23
 *    MS Excel 2007 workbooks reader
 *
 * Copyright (c) 2012 - 2021 XLSX
 *
 * @category   XLSX
 * @package    XLSX
 * @copyright  Copyright (c) 2012 - 2020 XLSX (https://github.com/shuchkin/simplexlsx/)
 * @license    MIT
 * @version    0.8.23
 */
 ...
 *
 * Example 1:
 * if ( $xlsx = XLSX::parse('book.xlsx') ) {
 *   print_r( $xlsx->rows() );
 * } else {
 *   echo XLSX::parseError();
 * }
 *
 ...
 *
 * Example 8: read data
 * if ( $xlsx = XLSX::parseData( file_get_contents('http://www.example.com/example.xlsx') ) ) {
