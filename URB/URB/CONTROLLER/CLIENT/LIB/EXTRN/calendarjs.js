...
function calendarJs( id, options, startDateTime ) {
    ...
    function buildDefaultOptions( newOptions ) {
        ...
        if ( !isDefined( _options.toTimeErrorMessage ) ) {
            _options.toTimeErrorMessage = "Selecione una hora válida para la hora 'Hasta'.";
        }

        if ( !isDefined( _options.toSmallerThanFromErrorMessage ) ) {
            _options.toSmallerThanFromErrorMessage = "Seleccione una fecha 'Hasta' mayor que la fecha 'Desde'.";
        }

        if ( !isDefined( _options.titleErrorMessage ) ) {
            _options.titleErrorMessage = "El título no puede quedar vacío.";
        }
        ...
        if ( !isDefined( _options.confirmEventRemoveTitle ) ) {
            _options.confirmEventRemoveTitle = "Confirme el borrado del evento";
        }

        if ( !isDefined( _options.confirmEventRemoveMessage ) ) {
            _options.confirmEventRemoveMessage = "Borrar el evento no se puede deshacer. ¿Quiere continuar?";
        }
        ...
        if ( !isDefined( _options.selectExportTypeTitle ) ) {
            _options.selectExportTypeTitle = "Seleccione el tipo de exportación";
        }
        ...
        if ( !isDefined( _options.selectColorsText ) ) {
            _options.selectColorsText = "Seleccione colores";
        }

        if ( !isDefined( _options.backgroundColorText ) ) {
            _options.backgroundColorText = "Color de fondo:";
        }
        ...
        if ( !isDefined( _options.repeatsText ) ) {
            _options.repeatsText = "Repeticiones:";
        }
        ...
        if ( !isDefined( _options.seriesIgnoreDatesText ) ) {
            _options.seriesIgnoreDatesText = "Fechas a ignorar:";
        }
        ...
        if ( !isDefined( _options.removeAllEventsInSeriesText ) ) {
            _options.removeAllEventsInSeriesText = "Borrar todos los eventos de la serie";
        }
        ...
        if ( !isDefined( _options.organizerEmailAddressText ) ) {
            _options.organizerEmailAddressText = "Correo del organizer:";
        }
