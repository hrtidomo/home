...
$appPath       = trim($configuration["BATCHROOT"]) . "/APIHOME";
require_once $globalPath . '/MODEL/BL/Result.php';
require_once  $appPath   . '/APIHOMEWRK.php';
...
///$userx = $_GET['userx'];
  ...
  echo "PASOB";    
  $resultapihome = APIHOME::performTask($url, $username, $password,$module,$action,$flat,$userx);
  echo "PASOC";  
